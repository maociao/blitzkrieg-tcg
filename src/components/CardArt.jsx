...
const CardArt = ({ type, id, artPrompt, customSeed }) => {
  ...
  return (
    <div className="w-full h-24 rounded-md overflow-hidden relative mb-2 bg-gray-700 group-hover:shadow-inner transition-all">
      {isLoading && !hasError && (
